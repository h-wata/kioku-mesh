...
だった: #300 はアンカー1 には追記しておらず、アンカー1の #287/#293 とは衝突しない
（#291 とはアンカー2 で衝突する。実測: #287+#300、#293+#300 は `git merge-tree` で
clean、#291+#300 は `CHANGELOG.md` の content conflict）。また #295 は
