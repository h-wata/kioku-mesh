...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        help='max seconds a save may trail an opportunity and still cover it (default: %(default)s)',
    )
    parser.add_argument(
        '--require-type-match',
        action='store_true',
    ...
    parser.add_argument(
        ...
        type=float,
        default=None,
        help='exit non-zero when coverage is below this fraction (0-1); for CI gating',
    )
